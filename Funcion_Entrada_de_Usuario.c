/*
   ...
   El programa recibe y descarta valores de entrada de tipo char, unsigned char, 
   short int, unsigned short int, int, unsigned int, long int, unsigned long int
   y un array de 50 char. 
*/
...
/*		4- Función principal (Descripción de uso)	*///--------------------------------------
	void main()
	{
		...
		printf("\n\t%c%c VALOR INGRESADO %s %c%c\n\n" , 219, 219, DatosDeEntrada.array_fifty , 219, 219 );
